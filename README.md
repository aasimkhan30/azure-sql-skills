...
# Microsoft SQL agent skills (installation preview)

This public repository mirrors the Microsoft SQL plugin structure for end-to-end installation testing. Skill bodies, references, scripts, and data files are placeholders; use the [official repository](https://github.com/microsoft/microsoft-sql) for operational guidance.

The upstream Microsoft SQL product team publishes plugins for building, operating, and migrating
Microsoft SQL data platforms. This preview preserves their package layout and catalog descriptions
for installation testing while replacing the skill guidance with placeholders.
...
```bash
copilot plugin marketplace add https://github.com/aasimkhan30/microsoft-sql.git
...
```text
/plugin marketplace add aasimkhan30/microsoft-sql
...
```bash
claude plugin marketplace add https://github.com/aasimkhan30/microsoft-sql.git
...
```bash
codex plugin marketplace add https://github.com/aasimkhan30/microsoft-sql.git
...
```json
{
  ...
  "chat.plugins.marketplaces": [
    "https://github.com/aasimkhan30/microsoft-sql"
  ]
}
```
...
```bash
git clone https://github.com/aasimkhan30/microsoft-sql.git
