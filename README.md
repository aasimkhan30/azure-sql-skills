# SQL agent skills (installation preview)

This public preview keeps the marketplace structure and skill names, but all skill bodies and references are placeholders for installation testing.

Agent skill plugins for Azure SQL Database, SQL Server to Azure migration, and Fabric Database Hub estate observability.

This repository is an independent installation preview copied from the
`publish/agentskills-marketplace` branch of `microsoft/azure-sql-skills`. All skill bodies and references are placeholders.
