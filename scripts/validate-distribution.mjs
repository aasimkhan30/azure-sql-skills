...
for (const pluginName of expectedPlugins) {
  ...
  for (const manifestName of manifestFiles) {
    ...
    if (manifest.repository !== "https://github.com/aasimkhan30/microsoft-sql") {
      fail(`${relative(manifestPath)}: repository must point to aasimkhan30/microsoft-sql`);
    }
  }
...
for (const marketplaceName of marketplaceFiles) {
  ...
  for (const plugin of plugins) {
    ...
    if (
      ...
      plugin.repository !== "https://github.com/aasimkhan30/microsoft-sql"
    ) {
  ...
  if (
    ...
    marketplace.owner.url !== "https://github.com/aasimkhan30/microsoft-sql"
  ) {
